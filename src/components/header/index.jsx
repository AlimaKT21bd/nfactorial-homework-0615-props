...
const MaterialUISwitch = styled(Switch)(({ theme }) => ({
    ...
    '& .MuiSwitch-switchBase': {
      ...
      '&.Mui-checked': {
        ...
        '& + .MuiSwitch-track': {
          opacity: 1,
          backgroundColor: theme.palette.mode === 'dark' ? '#999' : '#aab4be',
        },
      },
    },
    '& .MuiSwitch-thumb': {
  ...
  return (
    <header className = {`${theme}`}>
      ...
      <div className="search-layout">
        ...
        <TextField id="outlined-basic" label="Star Wars Search" variant="outlined" />
        <IconSearchSVG className="search-icon" />
        <div style={{ color: "white", paddingTop: "3.5rem" }}>
          I am fan of: {fan}
        </div>
      </div>
      <FormGroup>
